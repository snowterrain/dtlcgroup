...
var User = /** @class */ (function () {
    function User(id, name, phone, accomdationFlag, localTravelNeedsFlag, wiilYouVolunteerTospeakFlag, isVegetarianFlag, power, alterEgo) {
        this.id = id;
        this.name = name;
        this.phone = phone;
